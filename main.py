...
class CandleQuestion(BaseModel):
    idea_inferred: str = Field(
        description="Idea that can be inferred from the random seed, it doesn't have to be the idea of the text itself but it may cause you to think of something that may help generate an interesting question"
    )
